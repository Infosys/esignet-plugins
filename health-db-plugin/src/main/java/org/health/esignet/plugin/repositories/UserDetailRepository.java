package org.health.esignet.plugin.repositories;
...
public class UserDetailRepository {
    ...
    @Autowired
    @Qualifier("healthPluginJdbcTemplate")
    private JdbcTemplate healthPluginJdbcTemplate;

    public UserDetail findUserById(String individualId) {
        List<UserDetail> list = healthPluginJdbcTemplate.query(QUERY, new Object[]{individualId}, new RowMapper<UserDetail>() {
            @Override
