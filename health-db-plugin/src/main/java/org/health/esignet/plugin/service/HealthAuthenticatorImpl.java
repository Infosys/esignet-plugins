package org.health.esignet.plugin.service;
...
import org.health.esignet.plugin.dto.UserDetail;
import org.health.esignet.plugin.repositories.UserDetailRepository;
...
@Component
public class HealthAuthenticatorImpl implements Authenticator {
    ...
    public KycAuthResult doKycAuth(String relyingPartyId, String clientId, KycAuthDto kycAuthDto) throws KycAuthException {
        ...
        System.out.println(authChallenge.getAuthFactorType());
        switch (authChallenge.getAuthFactorType()) {
            case "OTP":
                ...
                break;
            default:
                throw new KycAuthException("auth_factor_not_supported");
        }
    ...
    public KycExchangeResult doKycExchange(String relyingPartyId, String clientId, KycExchangeDto kycExchangeDto) throws KycExchangeException {
        String storedToken = localMap.get(kycExchangeDto.getKycToken());

        if (storedToken == null)
            throw new KycExchangeException("token_not_found");

        UserDetail userDetail = userDetailRepository.findUserById(kycExchangeDto.getIndividualId());
    ...
    private void generateKeyCertificate() {
        try {
            ...
            throw new EsignetException("certificate_generation_failed");
        }
    }
